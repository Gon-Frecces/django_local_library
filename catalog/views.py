...
class LoanedBooksLibrarianView(PermissionRequiredMixin, generic.ListView):
    """Generic class-based view listing all books on loan to all users only visible to librarian."""
    permission_required = 'catalog.can_mark_returned'
    model = BookInstance
    template_name = 'catalog/bookborrowed_librarian_view.html'
    paginate_by = 10
...
def renew_book_librarian(request, pk):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # If form is invalid, render it again with errors
